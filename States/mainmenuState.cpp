...
void Mainmenu::initButtons() {
    ...
    this->buttons["GAME_STATE"] = new gui::Button(1280.f,798.f,300.f,150.f,
                                             &this->font, "New Game", 36,
                                             sf::Color(70,70,70,200),sf::Color(150,150,150,250),sf::Color(20,20,20,50),
                                             sf::Color(70,70,70,50),sf::Color(150,150,150,50),sf::Color(20,20,20,50)
    );
    this->buttons["SETTINGS_STATE"] = new gui::Button(1280.f,998.f,300.f,150.f,
                                                &this->font, "Settings", 36,
                                                sf::Color(70,70,70,200),sf::Color(150,150,150,250),sf::Color(20,20,20,50),
                                                sf::Color(70,70,70,50 ),sf::Color(150,150,150,50),sf::Color(20,20,20,50)
    );
    this->buttons["EDITOR_STATE"] = new gui::Button(1280.f,1198.f,300.f,150.f,
                                               &this->font, "Editor", 36,
                                               sf::Color(70,70,70,200),sf::Color(150,150,150,250),sf::Color(20,20,20,50),
                                               sf::Color(70,70,70,50 ),sf::Color(150,150,150,50),sf::Color(20,20,20,50)
    );
